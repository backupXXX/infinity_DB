...
-- FallenAngelX
ALTER TABLE db_version_Infinity_Update CHANGE COLUMN r44 r45 bit;
REPLACE INTO `db_version_Infinity_Update` (`version`) VALUES ('r45');

UPDATE db_version SET `cache_id`= 'r45';
UPDATE db_version SET `version`= 'YTDB579_Infinity_Update_r45';
